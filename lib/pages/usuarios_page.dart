...
class _UsuariosPageState extends State<UsuariosPage> {
  ...
  final usuarios = [
    ...
    Usuario(online: false, email: 'test1@test.com', nombre: 'Ana', uid: '2'),
    Usuario(online: true, email: 'test1@test.com', nombre: 'Rocio', uid: '3'),
  ];
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: (){
            // TODO: Desconectar el socket derver
